...
Generate meme from input image.
...
Most of the source codes of this project, `mimubotto` are stored in the `mimubotto` directory.
...
`make create-container` creates and launch the mimubotto container.
